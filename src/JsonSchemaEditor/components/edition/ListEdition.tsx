...
import CreateName from '../base/CreateName'
...
const ListEditionLong = (props: EditionProps) => {
  const { data, route, field, setDrawer, schemaEntry, fieldInfo } = props
...
export const ListEdition = (props: EditionProps) => {
  const { short } = props
  return short ? <ConstEdition {...props} /> : <ListEditionLong {...props} />
}
